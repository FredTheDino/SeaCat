...
void PhaseOnePlayer::jerk(Vec2 *new_acc){
    ...
    std::cout << "current Acceleration X" << acc_temp.x << std::endl;
    std::cout << "current Acceleration Y" << acc_temp.y << std::endl;
...
void PhaseOnePlayer::accelerate(){
    ...
    std::cout << "current Velocity X" << vel_temp.x << std::endl;
    std::cout << "current Velocity Y" << vel_temp.y << std::endl;
